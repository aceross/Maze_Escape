...
public class Level2State extends GameState {
  ...
  public Level2State(GameStateManager gsm) { super(gsm); }
  ...
  public void init() {
    ...
    player = new Player(Player.SPRITESIZE, Player.SPRITESIZE, 510, 350);
    ...
    this.music.load("/sfx/title.wav", "bgmusic");
  ...
  private void endLevel() {
    ...
    for (int i = 0; i < blocks.length; ++i) {
      for (int j = 0; j < blocks[0].length; ++j) {
        if (player.position[i][j] == blocks[15][2]) {
